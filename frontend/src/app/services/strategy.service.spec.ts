...
describe('StrategyService', () => {
  ...
  it('getAll_callsCorrectUrl', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiUrl}/marketing-strategies`);
  ...
  it('getActive_callsCorrectUrl', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiUrl}/marketing-strategies/active`);
    expect(req.request.method).toBe('GET');
    req.flush({});
  });
  ...
  it('getById_callsCorrectUrl', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiUrl}/marketing-strategies/1`);
    expect(req.request.method).toBe('GET');
    req.flush({});
  });
  ...
  it('generate_callsPostWithBody', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiUrl}/marketing-strategies/generate`);
  ...
  it('getStrategyCampaigns_callsCorrectUrl', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiUrl}/marketing-strategies/1/campaigns`);
    expect(req.request.method).toBe('GET');
    req.flush([]);
  });
  ...
  it('generateWeek_callsPost', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiUrl}/marketing-strategies/1/generate-week`);
    expect(req.request.method).toBe('POST');
    req.flush([]);
  });
});
